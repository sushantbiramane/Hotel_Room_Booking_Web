            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="room-details-item">
                        <img src="img/room/<%=hr.getImage()%>" alt="">
                        <div class="rd-text">
                            <div class="rd-title">
                                <h3><%=hr.getType() %></h3>
                                <div class="rdt-right">
                                   ...
                                   <%  if(b!=null){%>
                                    ...
                                    <a href="checkoutpage?ID=<%=hr.getID() %>">Booking Now</a>
                            ...
                            <h2><%=hr.getPrice() %>$/Pernight<span></span></h2>
                            <table>
                                <tbody>
                                    <tr>
                ...
                <div class="col-lg-4">
                    <div class="room-booking">
                        ...
                        <form action="Datecheck">
                         <div class="check-date">
					  <label for="date-in">Check In:</label>
					  <input type="hidden" value="<%=hr.getID() %>" name="id">
					...
					<div class="select-option">+
					  ...
					  <input id="room" name="Type" value=" <%=hr.getType() %>">
