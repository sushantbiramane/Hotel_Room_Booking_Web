...
%>
                <div class="col-lg-4 col-md-6">
                    ...
                    <div class="room-item">
                        <img src="img/room/<%=hrd.getImage() %>" alt="">
                        <div class="ri-text">
                            <h4><%=hrd.getType() %></h4>
                            <h3><%=hrd.getPrice() %>$/Pernight</h3>
                            <table>
                                <tbody>
                                    <tr>
                            ...
                            <a href="roombooking?ID=<%=hrd.getID() %>" class="primary-btn">More Details</a>
...
%>
    <div class="col-lg-12">
        <p style="color:red; text-align:center;">No rooms available at the moment.</p>
    </div>
<%
    }
%>
