                        ...
                        <div class="nav-menu">
                            <nav class="mainmenu">
                                <ul>
                                    ...
                                    <li><a href="contact">Contact</a></li>
                                   <%BookingRegistrationBean b=(BookingRegistrationBean)session.getAttribute("User"); %>
                                    <%if(b!=null){ %>
                                    <li><a href="#">Welcome<%=b.getName() %></a></li>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6">
                    <div class="blog-item set-bg" data-setbg="img/blog/blog-1.jpg">
                        <div class="bi-text">
                            ...
                            <h4><a href="blog_details">Tremblant In Canada</a></h4>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="blog-item set-bg" data-setbg="img/blog/blog-2.jpg">
                        <div class="bi-text">
                            ...
                            <h4><a href="blog_details">Choosing A Static Caravan</a></h4>
                            <div class="b-time"><i class="icon_clock_alt"></i> 15th April, 2019</div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6">
                    <div class="blog-item set-bg" data-setbg="img/blog/blog-3.jpg">
                        <div class="bi-text">
                            ...
                            <h4><a href="blog_details">Copper Canyon</a></h4>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="blog-item set-bg" data-setbg="img/blog/blog-4.jpg">
                        <div class="bi-text">
                            ...
                            <h4><a href="blog_details">A Time Travel Postcard</a></h4>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="blog-item set-bg" data-setbg="img/blog/blog-6.jpg">
                        <div class="bi-text">
                            <span class="b-tag">Travel Trip</span>
                            <h4><a href="blog_details">Virginia Travel For Kids</a></h4>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="blog-item set-bg" data-setbg="img/blog/blog-7.jpg">
                        <div class="bi-text">
                            <span class="b-tag">Travel Trip</span>
                            <h4><a href="blog_details">Bryce Canyon A Stunning</a></h4>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="blog-item set-bg" data-setbg="img/blog/blog-8.jpg">
                        <div class="bi-text">
                            ...
                            <h4><a href="blog_details">Motorhome Or Trailer</a></h4>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="blog-item set-bg" data-setbg="img/blog/blog-9.jpg">
                        <div class="bi-text">
                            <span class="b-tag">Camping</span>
                            <h4><a href="blog_details">Lost In Lagos Portugal</a></h4>
                            <div class="b-time"><i class="icon_clock_alt"></i> 30th April, 2019</div>
                        </div>
                    </div>
                </div>
